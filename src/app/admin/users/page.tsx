          ...
          {loading ? (
            ...
            <Table>
                ...
                <TableRow>
                    ...
                    <TableHead>Wallet (Deposit/Winnings)</TableHead>
                ...
                {filteredUsers.map((user) => (
                    ...
                    <TableCell>
                        ₹{user.depositBalance.toFixed(2)} / <span className="text-green-600 font-medium">₹{user.winningsBalance.toFixed(2)}</span>
                    </TableCell>
